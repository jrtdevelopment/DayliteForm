...
apiKey = 'Bearer kVitMPD48pE5yUqaIhqMXjgQkL4Wtg' #Put the API key here, saves you having to copy and past it into your code
...
print "Weclome to the the TakeInput Branch"
